<template>
  <div class="table-wrap">
      <div class="title">
          <div class="num"><span class="txt">1</span></div>
          <div class="box">
              <div class="shuxian"></div>
              <div class="name">News Release List</div>
          </div>
      </div>
      <el-table
...
import { getJournalisListApi } from "@/api/product/home";
import { ElMessage } from "element-plus";
import type { FormInstance } from "element-plus";

onMounted(async()=>{
   const res = await getJournalisListApi()
   tableData.value = res
})
